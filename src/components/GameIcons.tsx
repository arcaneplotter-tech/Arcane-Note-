  ...
  if (theme === 'minecraft') {
    switch (name) {
      ...
      case 'GrassBlock':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            {/* Dirt base */}
            <rect x="0" y="0" width="16" height="16" fill="#795548" />
            {/* Grass top */}
            <rect x="0" y="0" width="16" height="6" fill="#4caf50" />
            {/* Grass side details */}
            <rect x="0" y="6" width="2" height="2" fill="#4caf50" />
            <rect x="4" y="6" width="2" height="1" fill="#4caf50" />
            <rect x="8" y="6" width="3" height="2" fill="#4caf50" />
            <rect x="13" y="6" width="3" height="1" fill="#4caf50" />
            {/* Dirt highlights/shadows */}
            <rect x="2" y="8" width="2" height="2" fill="#5d4037" />
            <rect x="10" y="10" width="3" height="2" fill="#8d6e63" />
            <rect x="5" y="12" width="2" height="1" fill="#5d4037" />
            {/* Grass highlights */}
            <rect x="2" y="1" width="2" height="2" fill="#81c784" />
            <rect x="11" y="2" width="3" height="1" fill="#81c784" />
          </svg>
        );
      case 'EndBlock':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            {/* End stone base */}
            <rect x="0" y="0" width="16" height="16" fill="#dee2a1" />
            {/* Texture details */}
            <rect x="2" y="2" width="2" height="2" fill="#c5c980" />
            <rect x="10" y="3" width="3" height="2" fill="#c5c980" />
            <rect x="5" y="8" width="4" height="3" fill="#c5c980" />
            <rect x="12" y="10" width="2" height="2" fill="#c5c980" />
            <rect x="1" y="12" width="3" height="1" fill="#c5c980" />
            {/* Darker spots */}
            <rect x="7" y="1" width="1" height="1" fill="#a8ad5e" />
            <rect x="14" y="6" width="1" height="2" fill="#a8ad5e" />
            {/* Purple particles/glow */}
            <circle cx="8" cy="8" r="1.5" fill="#6c5ce7" opacity="0.4" />
            <rect x="4" y="4" width="1" height="1" fill="#a29bfe" opacity="0.6" />
            <rect x="11" y="12" width="1" height="1" fill="#a29bfe" opacity="0.6" />
          </svg>
        );
      case 'MinecraftLogo':
        return (
          <svg viewBox="0 0 24 24" className={className} style={style}>
            <rect x="2" y="2" width="20" height="20" fill="#373737" />
            <rect x="4" y="4" width="16" height="16" fill="#c6c6c6" />
            <rect x="6" y="6" width="4" height="4" fill="#4caf50" />
            <rect x="14" y="6" width="4" height="4" fill="#4caf50" />
            <rect x="8" y="14" width="8" height="2" fill="#373737" />
            <rect x="8" y="12" width="2" height="2" fill="#373737" />
            <rect x="14" y="12" width="2" height="2" fill="#373737" />
          </svg>
        );
      case 'DirtBlock':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            ...
            <rect x="10" y="3" width="3" height="2" fill="#8d6e63" />
            <rect x="5" y="8" width="4" height="3" fill="#5d4037" />
            <rect x="12" y="10" width="2" height="2" fill="#8d6e63" />
          </svg>
        );
      case 'StoneBlock':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            ...
            <rect x="10" y="4" width="4" height="4" fill="#8c8c8c" />
            <rect x="4" y="10" width="2" height="2" fill="#666666" />
            <rect x="12" y="12" width="2" height="2" fill="#8c8c8c" />
          </svg>
        );
      case 'DiamondBlock':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="0" y="0" width="16" height="16" fill="#63e2e2" />
            <rect x="0" y="0" width="16" height="1" fill="#ffffff" opacity="0.5" />
            <rect x="0" y="0" width="1" height="16" fill="#ffffff" opacity="0.5" />
            <rect x="15" y="0" width="1" height="16" fill="#000000" opacity="0.2" />
            <rect x="0" y="15" width="16" height="1" fill="#000000" opacity="0.2" />
            <rect x="4" y="4" width="8" height="8" fill="#ffffff" opacity="0.3" />
            <rect x="6" y="6" width="4" height="4" fill="#ffffff" opacity="0.5" />
          </svg>
        );
      case 'CraftingTable':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="0" y="0" width="16" height="16" fill="#795548" />
            <rect x="0" y="0" width="16" height="2" fill="#a1887f" />
            <rect x="2" y="4" width="4" height="4" fill="#4e342e" />
            <rect x="10" y="4" width="4" height="4" fill="#4e342e" />
            <rect x="2" y="10" width="12" height="4" fill="#3e2723" />
          </svg>
        );
      case 'MinecraftSword':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="10" y="2" width="2" height="2" fill="#63e2e2" />
            <rect x="8" y="4" width="2" height="2" fill="#63e2e2" />
            <rect x="6" y="6" width="2" height="2" fill="#63e2e2" />
            <rect x="4" y="8" width="2" height="2" fill="#63e2e2" />
            <rect x="2" y="10" width="2" height="2" fill="#795548" />
            <rect x="4" y="10" width="2" height="2" fill="#795548" />
            <rect x="2" y="8" width="2" height="2" fill="#795548" />
            <rect x="0" y="12" width="2" height="2" fill="#5d4037" />
          </svg>
        );
      case 'MinecraftPickaxe':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="4" y="2" width="10" height="2" fill="#63e2e2" />
            <rect x="12" y="4" width="2" height="2" fill="#63e2e2" />
            <rect x="2" y="4" width="2" height="2" fill="#63e2e2" />
            <rect x="7" y="4" width="2" height="2" fill="#795548" />
            <rect x="6" y="6" width="2" height="2" fill="#795548" />
            <rect x="5" y="8" width="2" height="2" fill="#795548" />
            <rect x="4" y="10" width="2" height="2" fill="#795548" />
            <rect x="3" y="12" width="2" height="2" fill="#795548" />
          </svg>
        );
      case 'MinecraftSun':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="2" y="2" width="12" height="12" fill="#fff176" />
      ...
      case 'MinecraftMoon':
        return (
          <svg viewBox="0 0 16 16" className={className} style={style}>
            <rect x="2" y="2" width="12" height="12" fill="#e0e0e0" />
            <rect x="4" y="4" width="8" height="8" fill="#bdbdbd" />
            <rect x="3" y="3" width="2" height="2" fill="#9e9e9e" />
            <rect x="10" y="5" width="3" height="3" fill="#9e9e9e" />
            <rect x="6" y="10" width="2" height="2" fill="#9e9e9e" />
          </svg>
        );
      default:
        break;
